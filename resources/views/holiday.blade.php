...
<br></br>
        ...
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right2">
                <a href="{{ url('holidayAdd')}}" class = "btn btn-success btn-sm" ><i class="fa fa-plus"></i>Add Leave</a>  
            </div>
        </div>
    </div>
    <br></br>
        ...
        <tr>
            ...
            <td>
                <form action="{{ url('holidaydestroy', $item->id) }}" method="POST">
                    ...
                    <a class="btn btn-primary" href="{{ route('holidayEdit',$item->id) }}"> <i class="fa fa-pen"></i>Edit</a>
                    @csrf
                    {{ method_field('GET') }}
